...
pub fn create_array_prototype<'a>(factory: &EntityFactory<'a>) -> Prototype<'a> {
  ...
  prototype.insert("concat", factory.immutable_unknown /*pure_fn_returns_array*/);
  prototype.insert("copyWithin", factory.pure_fn_returns_unknown /* mutates_self */);
  prototype.insert("entries", factory.immutable_unknown /*pure_fn_returns_array*/);
  prototype.insert("every", factory.pure_fn_returns_boolean);
  prototype.insert("fill", factory.pure_fn_returns_unknown /* mutates_self */);
  prototype.insert("filter", factory.immutable_unknown /*pure_fn_returns_array*/);
  ...
  prototype.insert("flat", factory.immutable_unknown /*pure_fn_returns_array*/);
  prototype.insert("flatMap", factory.immutable_unknown /*pure_fn_returns_array*/);
  ...
  prototype.insert("map", factory.immutable_unknown /*pure_fn_returns_array*/);
  ...
  prototype.insert("slice", factory.immutable_unknown /*pure_fn_returns_array*/);
  prototype.insert("some", factory.pure_fn_returns_boolean);
  prototype.insert("sort", factory.pure_fn_returns_unknown /* mutates_self */);
  prototype
    .insert("splice", factory.immutable_unknown /*pure_fn_returns_array*/ /* mutates_self */);
